...
export const translations: Record<Lang, Dict> = {
  es: {
    ...
    "home.card2.text": "Crea una sala o únete con un código para jugar contra otra persona.",
    ...
    "home.card2.button": "Abrir multijugador",

    "multiplayer.title": "Multijugador online",
    "multiplayer.subtitle": "Crea una sala o únete a una partida con código.",
    "multiplayer.create": "Crear sala",
    "multiplayer.join": "Unirse",
    "multiplayer.createTitle": "Crear una nueva sala",
    "multiplayer.createText": "Elige el tamaño del tablero y comparte el código con tu rival.",
    "multiplayer.joinTitle": "Unirse a una sala",
    "multiplayer.joinText": "Introduce el código que te haya pasado tu rival.",
    "multiplayer.createRoom": "Crear sala",
    "multiplayer.joinRoom": "Unirse a la sala",
    "multiplayer.creating": "Creando…",
    "multiplayer.joining": "Uniéndose…",
    "multiplayer.roomCode": "Código de sala",
    "multiplayer.roomCodePlaceholder": "Ej. ABC123",
    "multiplayer.howItWorksTitle": "⚡ Cómo funciona",
    "multiplayer.howItWorksText": "Una persona crea la sala y la otra se une con el código.",
    "multiplayer.howItWorksPill": "Tiempo real",
    "multiplayer.keepFeaturesTitle": "💡 Misma experiencia",
    "multiplayer.keepFeaturesText": "Se mantiene el tamaño del tablero y también puedes pedir pista.",
    "multiplayer.keepFeaturesPill": "Tablero + pista",
    ...
    "multiplayer.yourTurn": "Es tu turno",
    "multiplayer.opponentTurn": "Turno del rival",
    "multiplayer.leave": "Salir de la sala",
    "multiplayer.opponentLeft": "El rival se ha desconectado o ha abandonado la sala.",
    "multiplayer.error.create": "No se pudo crear la sala.",
  ...
  en: {
    ...
    "home.card2.text": "Create a room or join with a code to play against another person.",
    ...
    "home.card2.button": "Open multiplayer",

    "multiplayer.title": "Online multiplayer",
    "multiplayer.subtitle": "Create a room or join a match using a code.",
    "multiplayer.create": "Create room",
    "multiplayer.join": "Join",
    "multiplayer.createTitle": "Create a new room",
    "multiplayer.createText": "Choose the board size and share the code with your opponent.",
    "multiplayer.joinTitle": "Join a room",
    "multiplayer.joinText": "Enter the code shared by your opponent.",
    ...
    "multiplayer.roomCodePlaceholder": "E.g. ABC123",
    "multiplayer.howItWorksTitle": "⚡ How it works",
    "multiplayer.howItWorksText": "One player creates the room and the other joins with the code.",
    "multiplayer.howItWorksPill": "Real time",
    "multiplayer.keepFeaturesTitle": "💡 Same experience",
    "multiplayer.keepFeaturesText": "Board size is preserved and you can also ask for a hint.",
    "multiplayer.keepFeaturesPill": "Board + hint",
    "multiplayer.gameTitle": "Multiplayer match",
    ...
    "multiplayer.opponentLeft": "Your opponent disconnected or left the room.",
    "multiplayer.error.create": "Could not create room.",
