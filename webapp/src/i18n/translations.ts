...
export const translations: Record<Lang, Dict> = {
  es: {
    ...
    "multiplayer.joinRoom": "Unirse a sala",
    ...
    "multiplayer.playerOne": "Jugador azul",
    "multiplayer.playerTwo": "Jugador rojo",
    "multiplayer.yourTurn": "Tu turno",
    "multiplayer.opponentTurn": "Turno del rival",
    "multiplayer.winner": "Ganador",
    "multiplayer.opponentLeft": "El rival ha abandonado la partida",
  ...
  en: {
    ...
    "multiplayer.playerOne": "Blue player",
    "multiplayer.playerTwo": "Red player",
    "multiplayer.yourTurn": "Your turn",
    "multiplayer.opponentTurn": "Opponent's turn",
    "multiplayer.winner": "Winner",
    "multiplayer.opponentLeft": "Your opponent left the game",
