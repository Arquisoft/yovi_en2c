...
export const translations: Record<Lang, Dict> = {
    ...
    "game.finished.new": "Nueva partida",
    ...
    "pierule.modal.title": "Regla del pastel",
    "pierule.modal.description": "¿Quieres intercambiar colores con el primer jugador?",
    "pierule.modal.accept": "Intercambiar",
    "pierule.modal.decline": "Mantener",
    "pierule.used": "Regla usada",
    "local.activeturn": "Turno de",
  ...
  en: {
    ...
    "pierule.modal.title": "Pie rule",
    "pierule.modal.description": "Do you want to swap colours with the first player?",
    "pierule.modal.accept": "Swap",
    "pierule.modal.decline": "Keep",
    "pierule.used": "Pie rule used",
