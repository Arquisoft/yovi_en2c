...
describe("Game component — cobertura adicional", () => {
    ...
    test("clicking play again in overlay starts a new game", async () => {
        ...
        // Llamada 1: newGame → partida terminada (win)
        // Llamada 2: saveGameResult (silenciosa)
        // Llamada 3: newGame → nueva partida
        global.fetch = vi
            .fn()
            .mockResolvedValueOnce({
                ok: true,
        ...
        // ✅ MODIFICADO — ahora son 3 llamadas (newGame + saveGameResult + newGame)
        await waitFor(() => {
