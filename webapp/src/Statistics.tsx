...
type GameRowProps = { game: GameEntry; labelWin: string; labelLoss: string };

const GameRow: React.FC<GameRowProps> = ({ game, labelWin, labelLoss }) => {
  const isWin = game.result === "win";
  return (
    <tr style={{ borderBottom: "1px solid var(--stroke)" }}>
      <td style={{ padding: "10px 8px", fontWeight: 700 }}>{game.opponent}</td>
  ...
  return (
    <div className="page">
      ...
      <main className="container" style={{ paddingTop: 40 }}>
        ...
        >
          {/* Header — mismo patrón que Instructions y SelectDifficulty */}
          ...
          {/* Back — mismo patrón que Instructions */}
