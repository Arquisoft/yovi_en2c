...
For the full ADR history see the
link:https://github.com/Arquisoft/yovi_en2c/wiki/Architecture-Decision-Record[GitHub Wiki — ADR].
...
link:https://github.com/Arquisoft/yovi_en2c/wiki/Game-Modes[Game Modes wiki page]
